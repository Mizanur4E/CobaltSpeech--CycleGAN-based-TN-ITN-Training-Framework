'''
Implementation of simple encoder-decoder based seq2seq model. used bi-directional lstm.
it improves performance than normal baseline lstm network
'''
...
def get_build_train():    
    ...
    inp= layers.Embedding(vocab_size1, n_units, input_length=timestep, mask_zero=True)(inp1)
